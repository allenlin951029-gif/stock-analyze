...
def analyze_stock_technical(stock_id: str, as_of_date=None) -> str:
    ...
    # Chips (shares -> lots) + compare previous trading day
    out.append("💰 籌碼面 (三大法人):")

    def _to_lots(v_shares):
    ...
    # Volume fallback（若當天 Volume=0/NaN，改用前一交易日）
